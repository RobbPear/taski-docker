...
# В DATABASES указаны дефолтные значения для переменных — эти значения пригодятся, 
# если база будет развёрнута на локальном сервере, без использования файла .env. 
# Значения переменных заданы иные, чем в .env, чтобы в коде репозитория не оказалось
# секретных данных — паролей от реальных баз. 
